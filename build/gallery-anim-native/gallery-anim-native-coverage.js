...
return Anim._easing(e);
        ...
        running: {
            getter: function () {
                _yuitest_coverfunc("build/gallery-anim-native/gallery-anim-native.js", "getter", 262);
_yuitest_coverline("build/gallery-anim-native/gallery-anim-native.js", 263);
return this.get('node').getStyle(VENDOR + "AnimationName") !== 'none';
        ...
        paused: {
            getter: function () {
                _yuitest_coverfunc("build/gallery-anim-native/gallery-anim-native.js", "getter", 323);
...
Y.extend(Anim, Y.Base, {
        initializer: function (config) {
            _yuitest_coverfunc("build/gallery-anim-native/gallery-anim-native.js", "initializer", 353);
_yuitest_coverline("build/gallery-anim-native/gallery-anim-native.js", 354);
var from = this.get('from'),
                to = this.get('to'),
                key;

            _yuitest_coverline("build/gallery-anim-native/gallery-anim-native.js", 358);
this._frames = {'0%': from};

            _yuitest_coverline("build/gallery-anim-native/gallery-anim-native.js", 360);
for (key in config) {
                _yuitest_coverline("build/gallery-anim-native/gallery-anim-native.js", 361);
if (config.hasOwnProperty(key) && key.substr(-1) === '%') {
                    _yuitest_coverline("build/gallery-anim-native/gallery-anim-native.js", 362);
...
this._frames['100%'] = to;
         ...
         */
        run: function () {
            _yuitest_coverfunc("build/gallery-anim-native/gallery-anim-native.js", "run", 374);
_yuitest_coverline("build/gallery-anim-native/gallery-anim-native.js", 375);
var node = this.get('node');

            _yuitest_coverline("build/gallery-anim-native/gallery-anim-native.js", 377);
if (this.get('paused')) {
                _yuitest_coverline("build/gallery-anim-native/gallery-anim-native.js", 378);
node.setStyle(VENDOR + "AnimationPlayState", 'running');
            } else {_yuitest_coverline("build/gallery-anim-native/gallery-anim-native.js", 379);
if (!this.get('running')) {
                _yuitest_coverline("build/gallery-anim-native/gallery-anim-native.js", 380);
this._start();
            }}
...
return this;
         ...
         */
        pause: function () {
            _yuitest_coverfunc("build/gallery-anim-native/gallery-anim-native.js", "pause", 392);
...
return this;
        ...
        stop: function (finish) {
            _yuitest_coverfunc("build/gallery-anim-native/gallery-anim-native.js", "stop", 405);
...
return this;
        ...
        _start: function () {
            _yuitest_coverfunc("build/gallery-anim-native/gallery-anim-native.js", "_start", 410);
...
node.on(ANIMATION_END, function (e) {
                _yuitest_coverfunc("build/gallery-anim-native/gallery-anim-native.js", "(anonymous 4)", 426);
...
Anim._delete(name);
        ...
        _render: function (node, name, keyframes) {
            _yuitest_coverfunc("build/gallery-anim-native/gallery-anim-native.js", "_render", 442);
